...
#need to up date catalog areas to point to the write catalog names
#update some of the functions to match the data available
#update markdown scenario to match that of the data
